...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'a89f1560-d883-475a-b26b-183d806d539c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('cc7efa2f-e17d-4924-b9ea-2679807eb619');
      cy.get(`[data-cy="name"]`).should('have.value', 'cc7efa2f-e17d-4924-b9ea-2679807eb619');
