...
import ar.com.dones.app.config.Constants;
import ar.com.dones.app.domain.User;
import ar.com.dones.app.repository.AuthorityRepository;
import ar.com.dones.app.repository.UserRepository;
import ar.com.dones.app.security.AuthoritiesConstants;
import ar.com.dones.app.service.UserService;
import ar.com.dones.app.service.dto.AdminUserDTO;
import ar.com.dones.app.service.dto.PasswordChangeDTO;
import ar.com.dones.app.web.rest.vm.KeyAndPasswordVM;
import ar.com.dones.app.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
  ...
  void testFinishPasswordReset() throws Exception {
    ...
    restAccountMockMvc
      .perform(
        post("/api/account/reset-password/finish").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(keyAndPassword))
      )
      .andExpect(status().isOk());
