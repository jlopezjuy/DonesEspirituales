...
class ConfiguracionSistemaResourceIT {
    ...
    void createConfiguracionSistema() throws Exception {
        ...
        var returnedConfiguracionSistemaDTO = om.readValue(
            restConfiguracionSistemaMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(configuracionSistemaDTO))
                )
    ...
    void patchWithMissingIdPathParamConfiguracionSistema() throws Exception {
        ...
        restConfiguracionSistemaMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(configuracionSistemaDTO))
            )
            .andExpect(status().isMethodNotAllowed());
