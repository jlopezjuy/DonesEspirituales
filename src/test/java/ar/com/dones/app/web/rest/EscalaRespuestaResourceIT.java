...
class EscalaRespuestaResourceIT {
  ...
  void partialUpdateEscalaRespuestaWithPatch() throws Exception {
    ...
    partialUpdatedEscalaRespuesta.valor(UPDATED_VALOR).descripcion(UPDATED_DESCRIPCION);
  ...
  void fullUpdateEscalaRespuestaWithPatch() throws Exception {
    ...
    assertSameRepositoryCount(databaseSizeBeforeUpdate);
    assertEscalaRespuestaUpdatableFieldsEquals(partialUpdatedEscalaRespuesta, getPersistedEscalaRespuesta(partialUpdatedEscalaRespuesta));
  }
