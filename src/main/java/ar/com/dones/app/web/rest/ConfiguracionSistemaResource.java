...
public class ConfiguracionSistemaResource {
     ...
     */
    @GetMapping("")
    public List<ConfiguracionSistemaDTO> getAllConfiguracionSistemas() {
        LOG.debug("REST request to get all ConfiguracionSistemas");
        return configuracionSistemaService.findAll();
    }
