...
public class RespuestaUsuarioResource {
  ...
  public RespuestaUsuarioResource(RespuestaUsuarioService respuestaUsuarioService, RespuestaUsuarioRepository respuestaUsuarioRepository) {
  ...
  public ResponseEntity<List<RespuestaUsuarioDTO>> getAllRespuestaUsuarios(
    ...
    LOG.debug("REST request to get a page of RespuestaUsuarios");
    Page<RespuestaUsuarioDTO> page;
    if (eagerload) {
      page = respuestaUsuarioService.findAllWithEagerRelationships(pageable);
    } else {
      page = respuestaUsuarioService.findAll(pageable);
    }
