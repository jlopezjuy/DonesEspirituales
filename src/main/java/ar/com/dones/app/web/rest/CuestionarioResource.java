...
public class CuestionarioResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<CuestionarioDTO> createCuestionario(@Valid @RequestBody CuestionarioDTO cuestionarioDTO)
    ...
    public List<CuestionarioDTO> getAllCuestionarios() {
        LOG.debug("REST request to get all Cuestionarios");
