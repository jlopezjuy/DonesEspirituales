...
export class RespuestaUsuarioComponent implements OnInit {
  ...
  respuestaUsuarios = signal<IRespuestaUsuario[]>([]);
  isLoading = false;
  ...
  protected readonly respuestaUsuarioService = inject(RespuestaUsuarioService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IRespuestaUsuario): number => this.respuestaUsuarioService.getRespuestaUsuarioIdentifier(item);
  ...
  delete(respuestaUsuario: IRespuestaUsuario): void {
    const modalRef = this.modalService.open(RespuestaUsuarioDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.respuestaUsuario = respuestaUsuario;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.respuestaUsuarios.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IRespuestaUsuario[] | null): IRespuestaUsuario[] {
    return data ?? [];
  }
