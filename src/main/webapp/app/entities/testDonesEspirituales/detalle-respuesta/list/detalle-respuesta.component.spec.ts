...
import { sampleWithRequiredData } from '../detalle-respuesta.test-samples';
...
describe('DetalleRespuesta Management Component', () => {
  let comp: DetalleRespuestaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DetalleRespuestaComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.detalleRespuestas()[0]).toEqual(expect.objectContaining({ id: 18708 }));
  });

  describe('trackId', () => {
    it('should forward to detalleRespuestaService', () => {
      const entity = { id: 18708 };
      jest.spyOn(service, 'getDetalleRespuestaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDetalleRespuestaIdentifier).toHaveBeenCalledWith(entity);
