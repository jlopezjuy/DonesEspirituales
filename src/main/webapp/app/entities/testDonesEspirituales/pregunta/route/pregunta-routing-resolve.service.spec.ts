...
import preguntaResolve from './pregunta-routing-resolve.service';

describe('Pregunta routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: PreguntaService;
  let resultPregunta: IPregunta | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IPregunta returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        preguntaResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPregunta).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPregunta>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
