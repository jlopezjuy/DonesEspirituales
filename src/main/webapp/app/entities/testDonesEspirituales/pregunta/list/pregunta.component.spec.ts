...
import { sampleWithRequiredData } from '../pregunta.test-samples';
...
describe('Pregunta Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PreguntaComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.preguntas()[0]).toEqual(expect.objectContaining({ id: 28174 }));
  });

  describe('trackId', () => {
    it('should forward to preguntaService', () => {
      const entity = { id: 28174 };
      jest.spyOn(service, 'getPreguntaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPreguntaIdentifier).toHaveBeenCalledWith(entity);
