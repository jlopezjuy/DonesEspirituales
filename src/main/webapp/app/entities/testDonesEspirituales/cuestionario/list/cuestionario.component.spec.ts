...
import { sampleWithRequiredData } from '../cuestionario.test-samples';
...
describe('Cuestionario Management Component', () => {
  let comp: CuestionarioComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CuestionarioComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.cuestionarios()[0]).toEqual(expect.objectContaining({ id: 24961 }));
  });

  describe('trackId', () => {
    it('should forward to cuestionarioService', () => {
      const entity = { id: 24961 };
      jest.spyOn(service, 'getCuestionarioIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCuestionarioIdentifier).toHaveBeenCalledWith(entity);
